...
/// JSON Pointers that correspond to each subschema.
///
/// For example:
///
/// ```cpp
...
private:
  using internal = typename std::vector<Pointer>;
...
/// definition, ignoring the top-level schema and reporting back JSON Pointers
/// that correspond to each subschema.
///
/// For example:
///
/// ```cpp
