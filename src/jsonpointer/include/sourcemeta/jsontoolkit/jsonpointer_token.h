...
/// @ingroup jsonpointer
template <typename Property> class GenericToken {
public:
  using Value = JSON;
  ...
  GenericToken(const JSON::Char *const property)
      : data{std::in_place_type<std::string>, property} {}
  ...
  auto operator==(const GenericToken<Property> &other) const noexcept -> bool {
