...
#define PARSE_WITH_TRACES(result, input, expected_size)                        \
  std::vector<std::tuple<sourcemeta::core::CallbackPhase,                      \
                         sourcemeta::core::JSON::Type, std::uint64_t,          \
                         std::uint64_t, sourcemeta::core::JSON>>               \
      traces;                                                                  \
  const auto result{sourcemeta::core::parse(                                   \
      input, [&traces](const sourcemeta::core::CallbackPhase phase,            \
...
#define EXPECT_TRACE(index, expected_phase, expected_type, expected_line,      \
  ...
  EXPECT_EQ(std::get<0>(traces.at(index)),                                     \
            sourcemeta::core::CallbackPhase::expected_phase);                  \
...
TEST(JSON_parse_callback, array_booleans) {
  ...
  EXPECT_TRACE(5, Post, Array, 4, 1, sourcemeta::core::parse(input));
}
...
TEST(JSON_parse_callback, array_empty_objects) {
  ...
  EXPECT_TRACE(2, Post, Object, 2, 4, sourcemeta::core::parse("{}"));
  EXPECT_TRACE(3, Pre, Object, 3, 3, sourcemeta::core::JSON{1});
  EXPECT_TRACE(4, Post, Object, 3, 4, sourcemeta::core::parse("{}"));
  EXPECT_TRACE(5, Post, Array, 4, 1, sourcemeta::core::parse(input));
}
...
TEST(JSON_parse_callback, array_empty_arrays) {
  ...
  EXPECT_TRACE(2, Post, Array, 2, 4, sourcemeta::core::parse("[]"));
  EXPECT_TRACE(3, Pre, Array, 3, 3, sourcemeta::core::JSON{1});
  EXPECT_TRACE(4, Post, Array, 3, 4, sourcemeta::core::parse("[]"));
  EXPECT_TRACE(5, Post, Array, 4, 1, sourcemeta::core::parse(input));
}
...
TEST(JSON_parse_callback, object_booleans) {
  ...
  EXPECT_TRACE(5, Post, Object, 4, 1, sourcemeta::core::parse(input));
}
...
TEST(JSON_parse_callback, object_empty_arrays) {
  ...
  EXPECT_TRACE(2, Post, Array, 2, 11, sourcemeta::core::parse("[]"));
  EXPECT_TRACE(3, Pre, Array, 3, 10, sourcemeta::core::JSON{"bar"});
  EXPECT_TRACE(4, Post, Array, 3, 11, sourcemeta::core::parse("[]"));
  EXPECT_TRACE(5, Post, Object, 4, 1, sourcemeta::core::parse(input));
}
...
TEST(JSON_parse_callback, object_empty_objects) {
  ...
  EXPECT_TRACE(2, Post, Object, 2, 11, sourcemeta::core::parse("{}"));
  EXPECT_TRACE(3, Pre, Object, 3, 10, sourcemeta::core::JSON{"bar"});
  EXPECT_TRACE(4, Post, Object, 3, 11, sourcemeta::core::parse("{}"));
  EXPECT_TRACE(5, Post, Object, 4, 1, sourcemeta::core::parse(input));
}
...
TEST(JSON_parse_callback, complex_1) {
  ...
  EXPECT_TRACE(5, Post, Object, 5, 5,
               sourcemeta::core::parse(input).at(0).at("foo"));
  EXPECT_TRACE(6, Post, Object, 6, 3, sourcemeta::core::parse(input).at(0));
  EXPECT_TRACE(7, Post, Array, 7, 1, sourcemeta::core::parse(input));
}
