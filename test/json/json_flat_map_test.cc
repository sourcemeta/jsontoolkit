...
TEST(JSON_flat_map, empty_by_default) {
  sourcemeta::jsontoolkit::FlatMap<sourcemeta::jsontoolkit::JSON::String, bool,
...
TEST(JSON_flat_map, set_insert_copy) {
  ...
  const sourcemeta::jsontoolkit::JSON::String key_1{"0"};
  const sourcemeta::jsontoolkit::JSON::String key_2{"1"};
  const sourcemeta::jsontoolkit::JSON::String key_3{"2"};
