...
#define EXPECT_FRAME_STATIC_DRAFT1_RESOURCE(frame, reference, root_id,         \
...
#define EXPECT_FRAME_STATIC_DRAFT1_POINTER(frame, reference, root_id,          \
                                           expected_pointer, expected_base,    \
                                           expected_relative_pointer)          \
...
TEST(JSONSchema_frame_draft1, anonymous_with_nested_schema_resource) {
  ...
  EXPECT_STATIC_REFERENCE(
      references, "/$schema", "http://json-schema.org/draft-01/schema",
...
TEST(JSONSchema_frame_draft1, explicit_argument_id_different) {
  ...
  EXPECT_FRAME_STATIC_DRAFT1_RESOURCE(frame,
                                      ...
                                      "https://www.sourcemeta.com/schema", "",
                                      "https://www.sourcemeta.com/schema", "");
  EXPECT_FRAME_STATIC_DRAFT1_RESOURCE(frame, "https://www.sourcemeta.com/test",
                                      "https://www.sourcemeta.com/schema",
                                      "/properties/one",
                                      "https://www.sourcemeta.com/test", "");
  EXPECT_FRAME_STATIC_DRAFT1_RESOURCE(frame, "https://www.example.com",
                                      "https://www.sourcemeta.com/schema", "",
                                      "https://www.sourcemeta.com/schema", "");
...
TEST(JSONSchema_frame_draft1, ref_metaschema) {
  ...
  EXPECT_STATIC_REFERENCE(
      ...
      "http://json-schema.org/draft-01/schema", std::nullopt);
  EXPECT_STATIC_REFERENCE(
      references, "/$ref", "http://json-schema.org/draft-01/schema",
      "http://json-schema.org/draft-01/schema", std::nullopt);
}
