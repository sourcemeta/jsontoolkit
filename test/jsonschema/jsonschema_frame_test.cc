...
TEST(JSONSchema_frame, nested_schemas_mixing_dialects) {
  ...
  EXPECT_FRAME_STATIC_POINTER(
      ...
      "http://json-schema.org/draft-04/schema#",
      "http://json-schema.org/draft-04/schema#",
      "https://www.sourcemeta.com/bar", "/type", {}, std::nullopt);
  EXPECT_FRAME_STATIC_POINTER(
