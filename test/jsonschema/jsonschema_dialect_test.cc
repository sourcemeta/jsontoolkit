...
TEST(jsonschema_dialect, jsonschema_draft_3) {
  const sourcemeta::jsontoolkit::JSON document{
      sourcemeta::jsontoolkit::parse(R"JSON({
...
TEST(jsonschema_dialect, jsonschema_draft_4) {
  const sourcemeta::jsontoolkit::JSON document{
      sourcemeta::jsontoolkit::parse(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "type": "object"
...
TEST(jsonschema_dialect, jsonschema_draft_4_one_hop) {
  const sourcemeta::jsontoolkit::JSON document{
      sourcemeta::jsontoolkit::parse(R"JSON({
    "$schema": "https://sourcemeta.com/metaschema_4"
  })JSON")};
...
TEST(jsonschema_dialect, jsonschema_draft_4_two_hops) {
  const sourcemeta::jsontoolkit::JSON document{
      sourcemeta::jsontoolkit::parse(R"JSON({
