...
#define EXPECT_FRAME_STATIC_DRAFT3_POINTER(frame, reference, root_id,          \
...
#define EXPECT_FRAME_STATIC_DRAFT3_RESOURCE(frame, reference, root_id,         \
                                            expected_pointer, expected_base,   \
                                            expected_relative_pointer)         \
...
TEST(JSONSchema_frame_draft3, explicit_argument_id_different) {
  ...
  EXPECT_FRAME_STATIC_DRAFT3_RESOURCE(frame, "https://www.example.com",
                                      "https://www.sourcemeta.com/schema", "",
                                      "https://www.sourcemeta.com/schema", "");
