...
#define EXPECT_FRAME_STATIC_DRAFT3(frame, reference, root_id,                  \
                                   expected_pointer)                           \
...
TEST(JSONSchema_frame_draft3, empty_schema) {
  ...
  EXPECT_FRAME_STATIC_DRAFT3(frame, "https://www.sourcemeta.com/schema",
                             "https://www.sourcemeta.com/schema", "");

  // JSON Pointers

  EXPECT_FRAME_STATIC_DRAFT3(frame, "https://www.sourcemeta.com/schema#/id",
                             "https://www.sourcemeta.com/schema", "/id");
  EXPECT_FRAME_STATIC_DRAFT3(frame,
...
TEST(JSONSchema_frame_draft3, one_level_applicators_without_identifiers) {
  ...
  EXPECT_FRAME_STATIC_DRAFT3(frame,
                             "https://www.sourcemeta.com/schema#/$schema",
                             "https://www.sourcemeta.com/schema", "/$schema");
  EXPECT_FRAME_STATIC_DRAFT3(frame, "https://www.sourcemeta.com/schema#/items",
                             "https://www.sourcemeta.com/schema", "/items");
  EXPECT_FRAME_STATIC_DRAFT3(
...
TEST(JSONSchema_frame_draft3, one_level_applicators_with_identifiers) {
  ...
  EXPECT_FRAME_STATIC_DRAFT3(frame, "https://www.sourcemeta.com/test/qux",
                             "https://www.sourcemeta.com/test/qux", "");
  EXPECT_FRAME_STATIC_DRAFT3(frame, "https://www.sourcemeta.com/foo",
                             "https://www.sourcemeta.com/test/qux", "/items");

  // JSON Pointers

  EXPECT_FRAME_STATIC_DRAFT3(frame, "https://www.sourcemeta.com/test/qux#/id",
  ...
  EXPECT_FRAME_STATIC_DRAFT3(frame, "https://www.sourcemeta.com/foo#/id",
                             "https://www.sourcemeta.com/test/qux",
                             "/items/id");
  EXPECT_FRAME_STATIC_DRAFT3(frame, "https://www.sourcemeta.com/foo#/type",
                             "https://www.sourcemeta.com/test/qux",
                             "/items/type");
...
TEST(JSONSchema_frame_draft3, explicit_argument_id_different) {
  ...
  EXPECT_FRAME_STATIC_DRAFT3(frame, "https://www.sourcemeta.com/schema",
                             "https://www.sourcemeta.com/schema", "");
  EXPECT_FRAME_STATIC_DRAFT3(frame, "https://www.sourcemeta.com/test",
                             "https://www.sourcemeta.com/schema",
                             "/properties/one");
  EXPECT_FRAME_STATIC_DRAFT3(frame, "https://www.example.com",
                             "https://www.sourcemeta.com/schema", "");
  EXPECT_FRAME_STATIC_DRAFT3(frame, "https://www.example.com/test",
                             "https://www.sourcemeta.com/schema",
                             "/properties/one");
  EXPECT_FRAME_STATIC_DRAFT3(frame, "https://www.test.com",
                             "https://www.sourcemeta.com/schema",
                             "/properties/two");
  ...
  EXPECT_FRAME_STATIC_DRAFT3(frame, "https://www.sourcemeta.com/test#/id",
                             "https://www.sourcemeta.com/schema",
                             "/properties/one/id");
  EXPECT_FRAME_STATIC_DRAFT3(frame, "https://www.test.com#/id",
                             "https://www.sourcemeta.com/schema",
                             "/properties/two/id");
