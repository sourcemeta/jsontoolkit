...
TEST(JSONSchema_compile_2019_09, additionalProperties_3_fast) {
  ...
  EVALUATE_TRACE_POST_DESCRIBE(
      schema, instance, 0,
      "The target document is expected to be of the given type");
  EVALUATE_TRACE_POST_DESCRIBE(schema, instance, 1,
                               "Loop over the properties of the target object");
}
...
TEST(JSONSchema_compile_2019_09, contains_12) {
  ...
  EVALUATE_TRACE_POST_DESCRIBE(schema, instance, 0,
                               "Abort evaluation on failure");
}
...
TEST(JSONSchema_compile_2019_09, recursiveRef_1) {
  ...
  EVALUATE_TRACE_POST_DESCRIBE(schema, instance, 0, "Jump to a dynamic anchor");
  EVALUATE_TRACE_POST_DESCRIBE(schema, instance, 1, "Emit an annotation");
  EVALUATE_TRACE_POST_DESCRIBE(schema, instance, 2,
                               "Loop over the properties of the target object");
}
