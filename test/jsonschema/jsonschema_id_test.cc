...
TEST(JSONSchema_id, loose_boolean) {
  const sourcemeta::jsontoolkit::JSON document{true};
  std::optional<std::string> id{
      sourcemeta::jsontoolkit::id(
          document, sourcemeta::jsontoolkit::official_resolver,
...
TEST(JSONSchema_id, loose_with_valid_dollar_id) {
  const sourcemeta::jsontoolkit::JSON document =
      sourcemeta::jsontoolkit::parse(R"JSON({
    "$id": "https://example.com/my-schema"
  })JSON");
...
TEST(JSONSchema_id, loose_with_invalid_dollar_id) {
  const sourcemeta::jsontoolkit::JSON document =
      sourcemeta::jsontoolkit::parse(R"JSON({
    "$id": false
  })JSON");
...
TEST(JSONSchema_id, loose_with_valid_id) {
  const sourcemeta::jsontoolkit::JSON document =
      sourcemeta::jsontoolkit::parse(R"JSON({
    "id": "https://example.com/my-schema"
  })JSON");
...
TEST(JSONSchema_id, loose_with_invalid_id) {
  const sourcemeta::jsontoolkit::JSON document =
      sourcemeta::jsontoolkit::parse(R"JSON({
    "id": false
  })JSON");
...
TEST(JSONSchema_id, loose_with_valid_dollar_id_and_invalid_id) {
  const sourcemeta::jsontoolkit::JSON document =
      sourcemeta::jsontoolkit::parse(R"JSON({
    "$id": "https://example.com/my-schema",
    "id": false
...
TEST(JSONSchema_id, loose_with_valid_id_and_invalid_dollar_id) {
  const sourcemeta::jsontoolkit::JSON document =
      sourcemeta::jsontoolkit::parse(R"JSON({
    "id": "https://example.com/my-schema",
    "$id": false
...
TEST(JSONSchema_id, loose_with_invalid_id_and_invalid_dollar_id) {
  const sourcemeta::jsontoolkit::JSON document =
      sourcemeta::jsontoolkit::parse(R"JSON({
    "$id": 1,
    "id": false
...
TEST(JSONSchema_id, loose_with_matching_id_and_dollar_id) {
  const sourcemeta::jsontoolkit::JSON document =
      sourcemeta::jsontoolkit::parse(R"JSON({
    "$id": "https://example.com/my-schema",
    "id": "https://example.com/my-schema"
...
TEST(JSONSchema_id, loose_with_non_matching_id_and_dollar_id) {
  const sourcemeta::jsontoolkit::JSON document =
      sourcemeta::jsontoolkit::parse(R"JSON({
...
TEST(JSONSchema_id, loose_with_resolvable_default_dialect) {
  const sourcemeta::jsontoolkit::JSON document =
      sourcemeta::jsontoolkit::parse(R"JSON({
    "$id": "http://example.com/my-schema",
    "id": "https://example.com/my-schema"
