...
#define EXPECT_FRAME_STATIC_DRAFT7_POINTER(frame, reference, root_id,          \
...
#define EXPECT_FRAME_STATIC_DRAFT7_RESOURCE(frame, reference, root_id,         \
                                            expected_pointer, expected_base,   \
                                            expected_relative_pointer)         \
...
#define EXPECT_FRAME_STATIC_DRAFT7_ANCHOR(frame, reference, root_id,           \
                                          expected_pointer, expected_base,     \
                                          expected_relative_pointer)           \
...
TEST(JSONSchema_frame_draft7, explicit_argument_id_different) {
  ...
  EXPECT_FRAME_STATIC_DRAFT7_RESOURCE(frame, "https://www.example.com",
                                      "https://www.sourcemeta.com/schema", "",
                                      "https://www.sourcemeta.com/schema", "");
  ...
  EXPECT_FRAME_STATIC_DRAFT7_POINTER(frame,
                                     "https://www.sourcemeta.com/schema#/$id",
                                     "https://www.sourcemeta.com/schema",
