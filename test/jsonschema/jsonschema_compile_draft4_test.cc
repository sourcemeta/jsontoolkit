...
TEST(JSONSchema_compile_draft4, ref_4) {
  ...
  EVALUATE_TRACE_POST_DESCRIBE(
      ...
      "The target is expected to match all of the given assertions");
  EVALUATE_TRACE_POST_DESCRIBE(
      schema, instance, 4, "Jump to another point of the evaluation process");
  ...
  EVALUATE_TRACE_POST_DESCRIBE(
      schema, instance, 7,
      "Mark the current position of the evaluation process for future jumps");
  EVALUATE_TRACE_POST_DESCRIBE(schema, instance, 8, "Emit an annotation");
  EVALUATE_TRACE_POST_DESCRIBE(
      schema, instance, 9,
      "The target is expected to match all of the given assertions");
}
...
TEST(JSONSchema_compile_draft4, ref_5) {
  ...
  EVALUATE_TRACE_POST_DESCRIBE(
      ...
      "The target document is expected to be of the given type");
  EVALUATE_TRACE_POST_DESCRIBE(
      schema, instance, 3, "Jump to another point of the evaluation process");
  EVALUATE_TRACE_POST_DESCRIBE(
      schema, instance, 4,
      "The target is expected to match all of the given assertions");
  EVALUATE_TRACE_POST_DESCRIBE(
...
TEST(JSONSchema_compile_draft4, additionalProperties_2) {
  ...
  EVALUATE_TRACE_POST_DESCRIBE(
      schema, instance, 3,
      "The target document is expected to be of the given type");
  EVALUATE_TRACE_POST_DESCRIBE(schema, instance, 4,
                               "Loop over the properties of the target object");
}
...
TEST(JSONSchema_compile_draft4, additionalProperties_4) {
  ...
  EVALUATE_TRACE_POST_DESCRIBE(
      schema, instance, 6,
      "The target document is expected to be of the given type");
  EVALUATE_TRACE_POST_DESCRIBE(schema, instance, 7,
                               "Loop over the properties of the target object");
}
...
TEST(JSONSchema_compile_draft4, not_1) {
  ...
  EVALUATE_TRACE_POST_DESCRIBE(
      schema, instance, 1,
      "The given schema is expected to not validate successfully");
}
...
TEST(JSONSchema_compile_draft4, enum_3) {
  ...
  EVALUATE_TRACE_POST_DESCRIBE(
      schema, instance, 0,
      "The target is expected to be equal to the given value");
}
...
TEST(JSONSchema_compile_draft4, uniqueItems_1) {
  ...
  EVALUATE_TRACE_POST_DESCRIBE(
      schema, instance, 0,
      "The target array is expected to not contain duplicates");
}
